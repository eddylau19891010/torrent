...
function installDarwin () {
  ...
  app.setAsDefaultProtocolClient('donutglaze')
...
function installWin32 () {
  ...
  const iconPath = path.join(
    process.resourcesPath, 'app.asar.unpacked', 'resources', 'DonutGlaze.ico'
  )
...
function uninstallWin32 () {
  ...
  unregisterFileHandlerWin32('.torrent', 'org.donutglaze.com', EXEC_COMMAND)
